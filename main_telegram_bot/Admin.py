...
async def add_bot_start(message: Message):
    ...
    if str(message.from_user.id) in str(ADMIN_ID):
        ...
        media = MediaGroup()
        media.attach_photo(InputFile('img/1.jpg'), 'Вид бота 1')
        media.attach_photo(InputFile('img/2.jpg'), 'Вид бота 2')
        media.attach_photo(InputFile('img/3.jpg'), 'Вид бота 3')
        media.attach_photo(InputFile('img/4.jpg'), 'Вид бота 4')
...
async def all_users_reg(message: Message):
    ...
    if str(message.from_user.id) in str(ADMIN_ID):
        ...
        with open("all_user.xlsx", 'rb', encoding="utf-8") as file:
